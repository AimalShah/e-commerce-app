...
export default function About() {
  return (
    <div className='text-center my-10 px-12 py-20 border border-red-900 my-20 border bg-whitesh flex flex-col justify-center items-center gap-12'>
     ...
     <p className='font-poppins text-zinc-600 lg:w-1/3 lg:text-lg md:w-1/2 '>
    ...
    >
      <Link to="shop" >
        <button className="p-3 lg:p-4 text-sm lg:text-lg bg-zinc-950 text-gray-200 flex items-center gap-3 justify-center ">
            Learn More
